  ...
  MochaWeb.testOnly(function(){
    describe('Shopping Cart: Server Methods', function () {
      ...
      describe("Adding an item", function () {
        var result = null;
        before(function(){
          result = Meteor.call("addToCart", "test", "Game-of-Thrones");
        });
        after(function(){
          Carts.remove({});
        });
        ...
        it("sets serie, name, price, discount, summary, image", function(){
          var item = result.items[0];
          chai.assert(item.serie);
      ...
      describe("Adding an item already added", function () {
        var result = null;
        before(function(){
          Meteor.call("addToCart", "test", "Game-of-Thrones");
          result = Meteor.call("addToCart", "test", "Game-of-Thrones");
        });
        after(function(){
          Carts.remove({});
      ...
      describe("Removing an item", function () {
        ...
        before(function(){
          Meteor.call("addToCart", "test", "Game-of-Thrones");
          result = Meteor.call("removeFromCart", "test", "Game-of-Thrones");
        });
        after(function(){
          Carts.remove({});
        });
